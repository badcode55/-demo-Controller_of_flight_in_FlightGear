...
class FG_CMD:
    ...
    #tianze' note:
    FlightGear interface class.
    提供了flightgear telnet 服务端的通信接口
    Properties 是以python字典的形式访问的
    ...
    def reposition(self):
        ...
        print("reposition complished", end=' ')
        self.print_local_time()
        return None
    ...
    def replay(self, pos = "ground", path = None, time=-1, speed_up = 0):
        ...
        print("replay to",pos, "complished!", end='time:')
        self.print_local_time()
        if speed_up:
    ...
    def auto_start(self):
        ...
        #2022年5月2日 没有在fg的prop里找到这个参数
        self.__setitem__("/controls/gear/brake-parking", 0)
        print("auto start complished .", end=' ')
        self.print_local_time()
        return None
